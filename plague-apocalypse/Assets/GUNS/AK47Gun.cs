...
//     public int magazineSize = 30;         // Grootte van magazijn (AK47)
//     public int reserveAmmo = 120;        // Reserve kogels (AK47)
//     public float reloadTime = 2.5f;      // Tijd om te herladen (AK47)
...
//             else
//             {
//                 Debug.LogWarning("AK47: Bullet prefab has no Rigidbody — it won't move.");
//             }
